...
class Login extends Component {
  ...
  componentDidMount() {
    ...
    /*if (this.props.clinicList.length < 1) */ this.props.dispatch({
      type: 'GET_CLINICLIST'
    });
  }
  doLogin = e => {
    ...
    return (
      <div className={styles.login}>
        <div className={styles.login_contain}>
          ...
          <form
              className={styles.login_information}
          ...
          >
            ...
            <select
                ...
                onChange={(...arg) =>
                this.changeLoginInformation(...arg, 'clinicId')
              }
                className={styles.select_boder}
            >
            ...
            <Input
                ...
                onChange={(...arg) =>
                this.changeLoginInformation(...arg, 'loginname')
              }
            ...
            <Input
                ...
                onChange={(...arg) =>
                this.changeLoginInformation(...arg, 'password')
              }
                onKeyUp={e => this.handleEnterKey(e)}
            />
          ...
          <div className={styles.login_notes}>
            ...
            <div>
              5. Please ensure you have verified the content before you sign the
              computer printouts
            </div>
