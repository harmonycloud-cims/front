    ...
    render() {
        ...
        return (
            <Typography component={'div'} className={classes.border}>
                <FormGroup row>
                    <Typography component={'div'} className={classes.table_cell}>Mon</Typography>
                    <Typography component={'div'} className={classes.table_cell}>Tue</Typography>
                    <Typography component={'div'} className={classes.table_cell}>Wed</Typography>
                    <Typography component={'div'} className={classes.table_cell}>Thur</Typography>
                    <Typography component={'div'} className={classes.table_cell}>Fri</Typography>
                </FormGroup>
                <FormGroup row>
                    {
