...
class AppointmentBook extends Component {
  ...
  componentDidMount() {
    ...
    let clinicRoomList = _.takeWhile(this.props.roomList, function(o) {
      return o.clinicId === clinicId;
    });
                ...
                <FormGroup component={'div'} className={classes.right_body}>
                  <FormGroup>
                    ...
                    <select
                        ...
                        onChange={(...arg) =>
                        this.changeInformation(...arg, 'clinic')
                      }
                    >
                  ...
                  <FormGroup row>
                    <FormGroup>
                      ...
                      <select
                          ...
                          onChange={(...arg) =>
                          this.changeInformation(...arg, 'type')
                        }
                      >
                        {this.props.encounterList.map(item => (
                          <option
                    ...
                    <FormGroup>
                      ...
                      <select
                          ...
                          onChange={(...arg) =>
                          this.changeInformation(...arg, 'room')
                        }
                      >
                        {this.state.clinicRoomList.map(item => (
