...
import { Paper, InputBase, IconButton, Popper, MenuItem, Typography, Divider, Menu, MenuList } from '@material-ui/core';
    ...
    render() {
        ...
        return (
            <Paper className={classes.root} elevation={1}>
                <InputBase className={classes.input} inputRef={node => {this.anchorel = node;}} onChange={this.handleToggle} placeholder="Search by ID/ Name/ Phone" value={this.state.value} onKeyUp={this.handleEnterKey}/>
                        ...
                        <Paper className={classes.paper}>
                            {
                                this.props.patientList.map((item, index) =>
                                    <MenuItem key={index} onClick={() => this.handleClose(item)} className={classes.menu_list}>
                            ...
                            <Divider/>
                            <MenuItem onClick={() => this.handleClose({})} className={classes.menu_list}>Not Found</MenuItem>
                        </Paper>
                    </Popper> {/*  :
